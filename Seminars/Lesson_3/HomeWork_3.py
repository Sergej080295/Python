...
# Создаем словарь со значениями букв для русского и английского алфавитов
letter_values = {
...
total_score = sum(letter_values.get(lett, 0) for lett in j)

print(f'Стоимость слова "{k}" равна {total_score} очков.')